...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>/static/js/prototype.js"></script>
  ...
  <body>
      <form id="uriForm"><input type="text" id="uri" value="ws://localhost:23456" style="width:200px;"> <input type="submit" id="connect" value="Connect"><input type="button" id="disconnect" value="Disconnect" disabled="disabled"></form><br>

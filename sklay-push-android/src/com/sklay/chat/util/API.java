...
public class API {
	...
	/*
	 * public static LinkedHashMap<String,String> sendMessage(Message msg,File
	 * file) throws Exception{ Map<String,String> map = new
	 * HashMap<String,String>(); map.put("content", msg.getContent());
	 * map.put("title", msg.getTitle()); map.put("sender", msg.getSender());
	 * map.put("receiver", msg.getReceiver()); map.put("type", msg.getType());
	 * map.put("fileType", msg.getFileType()); String json =
	 * httpPost(API_URL+"message_send.api",map,file);
	 * 
	 * return new Gson().fromJson(json, new
	 * TypeToken<LinkedHashMap<String,String>>(){}.getType()); }
	 */

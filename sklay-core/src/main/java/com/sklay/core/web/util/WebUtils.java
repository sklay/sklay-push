...
public class WebUtils extends org.springframework.web.util.WebUtils
{
    ...
    private static final String[] MOBILE_SPECIFIC_SUBSTRING = {"ipad", "iphone", "android", "midp", "opera mobi",
        "opera mini", "blackberry", "hp ipaq", "iemobile", "msiemobile", "windows phone", "htc", "lg", "mot", "nokia",
        "symbian", "fennec", "maemo", "tear", "midori", "armv", "windows ce", "windowsce", "smartphone", "240x320",
        "176x220", "320x320", "160x160", "webos", "palm", "sagem", "samsung", "sgh", "siemens", "sonyericsson", "mmp",
        "ucweb"};
    ...
    public static void writeToResponse(String result, HttpServletResponse response)
        throws IOException
    {
    ...
    public static boolean argumentsMatch(HttpServletRequest request, String arguments)
    {
